...
archive.ctl.ts$Treatment <- ifelse(archive.ctl.ts$Experiment == "2011", "control (2011)", "storage duration")
...
# add experiment  and treatment cols to archive.arc.ts
...
* Fig. 1 shows the direction of mean treatment effects over time in reference to the atmosphere (gray line)
* Fig. 2 shows treatment effects as means with inferential error bars (2x SE) [plan to add significance stars]
