...
* Fig. 1 shows treatment effects with inferential error bars (2x SE)
* Fig. 2 shows the direction of treatment effects over time in reference to the atmosphere (gray line)
