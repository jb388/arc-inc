...
all.14c <- merge(rbind(pre.14c, inc.14c), ts.epsn.avg, by = c("SampleName", "Period"))
...
5. Add ^14^C data to template. Note that archived sample $\Delta$^14^C data needs to be corrected for decay. The correction is very small and likely insignificant, but will do this anyway.
* decay correction formula is:
$$1000 \cdot \left( (FM \cdot e^{\frac{-year_{obs} + 1950}{8267}}) - 1 \right)$$
