...
4. Plot of CO~2~ fluxes over time. The final measurement points for a few samples that took >18 days to reach CO~2~ targets are excluded for display reasons. Respiration rates for those samples remained flat.
...
```
# Isotope data
Read in isotope data from various sources.
