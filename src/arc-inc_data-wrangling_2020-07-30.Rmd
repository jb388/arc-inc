...
Preincubation headspace CO~2~ concentations were only measured once for the control-1 samples, at the end of the four=day preincubation period. In order to compare the control-1 respiration rates more easily with the air-dry + storage treatment samples, Supplemental Figure 2 shows the air-dry + storage pre-incubation respiration rates plotted as a cumulative average for the preincubation period. However, as can be seen in Figure 1, headspace CO~2~ concentration was measured daily for the air-dry + storage samples.
...
```{r conceptual-model-fig1, fig.height=3.5, fig.width=6}
